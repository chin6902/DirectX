...
static constexpr SkillDef g_SkillDefs[SKILL_ID_COUNT] =
{
	...
	/* 7 OVERLOAD  */
	{
		...
		.impact = {.damage_mul = 1.3f, .kb_speed = 220.0f, .kb_time = 0.12f, .stun_time = 0.20f },
	...
	/* 8 STATIC_FROST */
	{
		...
		.life = 0.55f,
		.hitbox = {.radius = 15.0f },
		.target = {.chain_jumps = 5, .chain_range = 210.0f, .falloff = 0.6f, .min_damage_mul = 0.1f },
		.impact = {.damage_mul = 1.1f, .kb_speed = 120.0f, .kb_time = 0.10f, .stun_time = 0.15f },
	...
	/* 11 TESLA_TURRET */
	{
		...
		.impact = {.damage_mul = 0.4f, .kb_speed = 110.0f, .kb_time = 0.08f, .stun_time = 0.10f },
	...
	/* 13 FROSTFIRE_SPIKES */
	{
		...
		.impact = {.damage_mul = 1.8f, .kb_speed = 260.0f, .kb_time = 0.5f, .stun_time = 0.25f },
		.status = { { STATUS_SLOW, 2.5f, 0.65f } }, 
	...
	/* 15 PLASMA_ORBS */
	{
		...
		.impact = {.damage_mul = 0.2f, .kb_speed = 120.0f, .kb_time = 0.08f, .stun_time = 0.06f },
		.status = { { STATUS_BURN, 2.0f, 0.5f } },
	...
	/* 21 ULT_ICE_2  frost nova */
	{
		...
		.impact = {.damage_mul = 0.6f, .kb_speed = 260.0f, .kb_time = 0.20f, .stun_time = 0.30f },
	...
	/* 22 ULT_ICE_3  glacial beam */
	{
		...
		.impact = {.damage_mul = 4.5f, .kb_speed = 200.0f, .kb_time = 0.15f, .stun_time = 0.30f },
	...
	/* 24 ULT_THUNDER_3  tempest orb */
	{
		...
		.impact = {.damage_mul = 2.0f, .kb_speed = 240.0f, .kb_time = 0.13f, .stun_time = 0.18f },
