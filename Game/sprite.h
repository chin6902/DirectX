...
void Sprite_Draw(int texture_ID, float x, float y, int texture_x, int texture_y, int texture_width, int texture_height, const DirectX::XMFLOAT4& color = { 1.0f, 1.0f, 1.0f, 1.0f });

//好きなテクスチャを好きなサイズで切り取って好きな座標に好きなサイズに描画する
void Sprite_Draw(int texture_ID, float x, float y, float width, float height, int texture_x, int texture_y, int texture_width, int texture_height, const DirectX::XMFLOAT4& color = { 1.0f, 1.0f, 1.0f, 1.0f });
